...
@endif
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Edit Location</a></li>
    </ol>
</div>
...
<div class="container-fluid-md">
    <div class="row">
        <div class="col-md-6">
            {!! Form::model($location, ['method' => 'PATCH','route' => ['locations.update', $location->id], 'class'=>'form-horizontal form-bordered']) !!} 
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {!! Form::text('place_id', null, array('placeholder' => 'Place ID','class' => 'form-control', 'readonly')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {{ App\Location::where('id', $location->parent)->pluck('name')}}
                            </div>
                        </div>
                    </div>
